# Base class Person
class Person:
    def _init_(self, name, age, contact, role):
        self.name = name
        self.age = age
...
class Teacher(Person):
    def _init_(self, name, age, contact, departments, file_name):
        super()._init_(name, age, contact, role="Teacher")
...
class Student(Person):
    def _init_(self, name, age, contact, department, semester, courses, file_name):
        super()._init_(name, age, contact, role="Student")
...
student = Student(name="Amna", age=20, contact="67890", department="Computer Science", semester="4th", courses=["AI", "ML"], file_name="student_info.txt")
